...
function ForgotPassword() {
  ...
  return (
      <div class="register_container" id="container" style={{ background: "#0000" }}>
        <div class="form-container log-in-container"  style={{ marginTop: '18%' }}>
          <form style={{borderRadius: '30px'}}  className="form">
            <h1 style={{ marginTop: '20px' }}>Quên mật khẩu</h1>
            ...
            <span style={{ marginBottom: '10px' }}>Vui lòng nhập email của bạn để thay đổi mật khẩu.</span>
            ...
            <button  style={{  marginBottom: '20px', minHeight: '50px', minWidth: '100px', background: '#f18720', borderRadius: "10px", fontSize: '16px' }} type="button" onClick={onSubmit}>
              HOÀN TẤT
            </button>
          </form>
        </div>
